...
export const Locations: Record<string, Record<string, InputImageLocation>> = {
  ...
  MiddleEast: {
    Syria: { region: "ARAB", location: "SYR" },
    Lebanon: { region: "ARAB", location: "LBN" },
    Jordan: { region: "ARAB", location: "JOR" },
    SaudiArabia: { region: "ARAB", location: "SAU" },
    Kuwait: { region: "ARAB", location: "KWT" },
    UnitedArabEmirates: { region: "ARAB", location: "ARE" },
    Qatar: { region: "ARAB", location: "QAT" },
    Bahrain: { region: "ARAB", location: "BHR" },
    Oman: { region: "ARAB", location: "OMN" },
    Yemen: { region: "ARAB", location: "YEM" },
  },
  AustraliaAndOceania: {
